...
export function AppointmentCard({
    ...
    const getStatusColor = (status: AppointmentStatus) => {
        switch (status) {
            case AppointmentStatus.SCHEDULED: return 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300';
            case AppointmentStatus.CONFIRMED: return 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300';
            case AppointmentStatus.COMPLETED: return 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300';
            case AppointmentStatus.CANCELLED: return 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300';
            case AppointmentStatus.NOSHOW: return 'bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300';
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div className="flex-1 space-y-3">
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        >
                            <option value={AppointmentStatus.SCHEDULED} className="dark:bg-gray-900">Agendado</option>
                            <option value={AppointmentStatus.CONFIRMED} className="dark:bg-gray-900">Confirmado</option>
                            <option value={AppointmentStatus.COMPLETED} className="dark:bg-gray-900">Concluído</option>
                            <option value={AppointmentStatus.NOSHOW} className="dark:bg-gray-900">Não compareceu</option>
                            <option value={AppointmentStatus.CANCELLED} className="dark:bg-gray-900">Cancelado</option>
                        </select>
